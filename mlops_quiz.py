...
#     result_dataframe = pd.DataFrame(columns=['Gamma', 'C', 'train','dev','test'])
    ...
    print(df)
    print("==== Training Accuracy of Test / Training / Dev ")
    print(" ")
    ...
    print(" ")
    print("Dev accuracy min " , df['Val_Accuracy'].min())
    print("Dev accuracy max " , df['Val_Accuracy'].max())
    print("Dev accuracy mean " , df['Val_Accuracy'].mean())
    print("Dev accuracy median " , df['Val_Accuracy'].median())
